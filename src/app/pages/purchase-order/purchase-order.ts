...
export class PurchaseOrder implements OnInit {
  ...
  ngOnInit() {
    const defaultOrders = [
      ...
      { id: 2, orderNo: 'ORD-1002', supplier: 'Office Supplies Inc', amount: 500, orderDate: '02/11/2026', poNumber: 'ORD-1002', supplierName: 'Office Supplies Inc', reviewer1: 'Dave', reviewer2: '', approver: 'Eve', lineItems: [] },
    ];
